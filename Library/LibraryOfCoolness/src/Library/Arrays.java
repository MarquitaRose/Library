...
public class Arrays{
        ...
        String[] music_artists = new String[]{

            "Eminem", "Eminem", "Nicki Minaj", "Nicki Minaj", "Jay-Z", "Kanye West"

        };

        

        String[] pop_artists = new String[]{

            "Taylor Swift", "Taylor Swift", "Taylor Swift", "One Direction", "Katy Perry", "Rhianna", "One Direction", "Adele"

        };

        

        String [] rock_artists = new String[]{

            "OneRepublic", "OneRepublic", "OneRepublic", "ACDC", "Kansas", "ACDC", "Bastille"
